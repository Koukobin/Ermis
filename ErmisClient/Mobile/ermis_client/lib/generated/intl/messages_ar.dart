...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "account_delete_bullet1": MessageLookupByLibrary.simpleMessage(
      "حذف حسابك دون أي طريقة للاسترداد",
    ),
    ...
    "authentication_stage_credentials_exchange":
        MessageLookupByLibrary.simpleMessage("تبادل بيانات الاعتماد"),
    "authentication_stage_credentials_validation":
        MessageLookupByLibrary.simpleMessage("التحقق من بيانات الاعتماد"),
    ...
    "chat_backdrop": MessageLookupByLibrary.simpleMessage("خلفية المحادثة"),
    ...
    "credential_validation_success": MessageLookupByLibrary.simpleMessage(
      "تم تبادل بيانات الاعتماد بنجاح!",
    ),
    ...
    "login_backup_code_incorrect": MessageLookupByLibrary.simpleMessage(
      "رمز التحقق الاحتياطي غير صحيح.",
    ),
    "login_email_incorrect": MessageLookupByLibrary.simpleMessage(
      "بريد إلكتروني غير صحيح!",
    ),
    "login_error": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء تسجيل الدخول إلى حسابك! يرجى الاتصال بمسؤول الخادم وإبلاغه بأن الخادم معطل.",
    ),
    ...
    "message_length_exceeded": MessageLookupByLibrary.simpleMessage(
      "طول الرسالة يتجاوز الحد الأقصى للطول (%d حرفًا)",
    ),
    "message_type_not_implemented": MessageLookupByLibrary.simpleMessage(
      "نوع الرسالة لم يتم تنفيذه!",
    ),
    ...
    "notification_preview_display_part": MessageLookupByLibrary.simpleMessage(
      "عرض جزء من الرسالة في الإشعارات",
    ),
    "notification_preview_show": MessageLookupByLibrary.simpleMessage(
      "إظهار معاينات الرسائل",
    ),
    "notification_settings": MessageLookupByLibrary.simpleMessage(
      "إعدادات الإشعارات",
    ),
    "notification_sound": MessageLookupByLibrary.simpleMessage("صوت الإشعارات"),
    ...
    "profile_about": MessageLookupByLibrary.simpleMessage("حول"),
    "profile_camera": MessageLookupByLibrary.simpleMessage("الكاميرا"),
    "profile_change_name_id": MessageLookupByLibrary.simpleMessage(
      "الملف الشخصي، تغيير الاسم، المعرف",
    ),
    "profile_gallery": MessageLookupByLibrary.simpleMessage("المعرض"),
    "profile_hey_there": MessageLookupByLibrary.simpleMessage("مرحباً!"),
    "profile_id_copied": MessageLookupByLibrary.simpleMessage(
      "تم نسخ المعرف إلى الحافظة",
    ),
    "profile_name": MessageLookupByLibrary.simpleMessage("الاسم"),
    "profile_name_enter": MessageLookupByLibrary.simpleMessage("أدخل اسمك"),
    ...
    "profile_photo_fetch_error": MessageLookupByLibrary.simpleMessage(
      "حدث خطأ أثناء محاولة جلب صورة الملف الشخصي من قاعدة البيانات!",
    ),
    ...
    "theme_dark": MessageLookupByLibrary.simpleMessage("الوضع الداكن"),
    ...
    "version_capitalized": MessageLookupByLibrary.simpleMessage("الإصدار"),
