...
// This is a library that provides messages for a grc locale. All the
...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "abstract": MessageLookupByLibrary.simpleMessage("Ἀφηρημένος"),
    ...
    "account_confirm_proceed": MessageLookupByLibrary.simpleMessage(
      "βεβαίως θέλεις προχωρεῖν;",
    ),
    "account_delete": MessageLookupByLibrary.simpleMessage("ἀφαιρεῖν λογισμόν"),
    "account_delete_bullet1": MessageLookupByLibrary.simpleMessage(
      "ἀφαιρεῖν τὸν λογισμόν σου ἄνευ τρόπου ἀνακτήσεως",
    ),
    "account_delete_bullet2": MessageLookupByLibrary.simpleMessage(
      "ἀλείφειν τὴν ἱστορίαν τῶν ἀγγελιῶν σου",
    ),
    "account_delete_bullet3": MessageLookupByLibrary.simpleMessage(
      "ἀφαιρεῖν πάντας τοὺς διαλόγους σου",
    ),
    "account_delete_confirmation": MessageLookupByLibrary.simpleMessage(
      "ἀφαιρῶν τὸν λογισμὸν τοῦτον",
    ),
    "account_delete_error": MessageLookupByLibrary.simpleMessage(
      "τι ἐγένετο κακῶς ἐν τῷ ἀφαιρεῖν λογισμόν",
    ),
    "account_delete_my": MessageLookupByLibrary.simpleMessage(
      "ἀφαιρεῖν τὸν λογισμόν μου",
    ),
    "account_settings": MessageLookupByLibrary.simpleMessage("τάξεις λογισμοῦ"),
    "add_user": MessageLookupByLibrary.simpleMessage("Προσθεῖναι χρήστην"),
    "address_not_recognized": MessageLookupByLibrary.simpleMessage(
      "διεύθυνσις οὐ γιγνώσκεται",
    ),
    "app_info": MessageLookupByLibrary.simpleMessage("πληροφορίαι ἐφαρμογῆς"),
    ...
    "authentication_stage_credentials_exchange":
        MessageLookupByLibrary.simpleMessage("ἀνταλλαγὴ πιστευμάτων"),
    "authentication_stage_credentials_validation":
        MessageLookupByLibrary.simpleMessage("πιστεύματα ἐλέγχονται"),
    ...
    "change_username_success": MessageLookupByLibrary.simpleMessage(
      "ὄνομα χρήστου μετεβλήθη καλῶς",
    ),
    "chat_backdrop": MessageLookupByLibrary.simpleMessage("ὑπόβαθρον διαλόγου"),
    ...
    "choose_friends": MessageLookupByLibrary.simpleMessage("Αἱρεῖσθαι φίλους"),
    ...
    "could_not_verify_server_certificate": MessageLookupByLibrary.simpleMessage(
      "Οὐκ ἠδυνήθην τὸ πιστοποιητικὸν τοῦ διακομιστοῦ βεβαιῶσαι",
    ),
    ...
    "create_account_email_exists": MessageLookupByLibrary.simpleMessage(
      "ἐπιστολὴ ἤδη ἐχρήσθη",
    ),
    "create_account_error": MessageLookupByLibrary.simpleMessage(
      "τι ἐγένετο κακῶς ἐν τῷ ποιεῖν τὸν λογισμόν σου",
    ),
    "create_account_success": MessageLookupByLibrary.simpleMessage(
      "λογισμὸς ἐγένετο καλῶς",
    ),
    "credential_validation_client_id_error":
        MessageLookupByLibrary.simpleMessage("ἀδύνατον ποιεῖν ἀριθμὸν πελάτου"),
    ...
    "credential_validation_success": MessageLookupByLibrary.simpleMessage(
      "πιστεύματα ἀντηλλάγησαν καλῶς",
    ),
    "credential_validation_username_invalid":
        MessageLookupByLibrary.simpleMessage(
          "ἀπαιτήσεις ὀνόματος χρήστου οὐκ ἐπληρώθησαν",
        ),
    "custom": MessageLookupByLibrary.simpleMessage("Ἰδιόμορφος"),
    ...
    "gradient": MessageLookupByLibrary.simpleMessage("Κλῖμαξ χρωμάτων"),
    ...
    "login_add_device_info": MessageLookupByLibrary.simpleMessage(
      "προστιθέναι πληροφορίας ὀργάνου",
    ),
    "login_backup_code_incorrect": MessageLookupByLibrary.simpleMessage(
      "ἄκυρος κώδιξ ἐπαληθεύσεως ἀντιγράφου",
    ),
    "login_email_incorrect": MessageLookupByLibrary.simpleMessage(
      "ἄκυρος ἐπιστολή",
    ),
    "login_error": MessageLookupByLibrary.simpleMessage(
      "τι ἐγένετο κακῶς ἐν τῷ εἰσιέναι εἰς τὸν λογισμόν σου! παρακαλῶ ἐπικοινώνει τῷ διοικητῇ τοῦ ὑπηρετοῦ καὶ λέγε αὐτῷ ὅτι ὁ ὑπηρέτης αὐτοῦ ἔβλαψεν",
    ),
    ...
    "login_success": MessageLookupByLibrary.simpleMessage(
      "εἰσῆλθες καλῶς εἰς τὸν λογισμόν σου",
    ),
    "login_toggle_password": MessageLookupByLibrary.simpleMessage(
      "μεταβάλλειν εἶδος συνθήματος",
    ),
    ...
    "message_length_exceeded": MessageLookupByLibrary.simpleMessage(
      "μῆκος ἀγγελίας ὑπερβαίνει μέγιστον μῆκος (%d γράμματα)",
    ),
    "message_type_not_implemented": MessageLookupByLibrary.simpleMessage(
      "εἶδος ἀγγελίας οὐ πεποίηται",
    ),
    ...
    "new_group": MessageLookupByLibrary.simpleMessage("Ὁμίλος νέος"),
    ...
    "notification_preview_show": MessageLookupByLibrary.simpleMessage(
      "δεικνύναι προθεωρίας ἀγγελιῶν",
    ),
    "notification_settings": MessageLookupByLibrary.simpleMessage(
      "τάξεις ἀγγελιῶν",
    ),
    "notification_sound": MessageLookupByLibrary.simpleMessage("ἦχος ἀγγελιῶν"),
    "notification_sound_select": MessageLookupByLibrary.simpleMessage(
      "αἱρεῖσθαι ἦχον ἀγγελιῶν",
    ),
    ...
    "privacy": MessageLookupByLibrary.simpleMessage("Τὸ ἴδιον"),
    "privacy_security_change_number": MessageLookupByLibrary.simpleMessage(
      "ἀσφάλεια, ἀλλαγὴ ἀριθμοῦ",
    ),
    "profile": MessageLookupByLibrary.simpleMessage("εἰκών"),
    "profile_about": MessageLookupByLibrary.simpleMessage("περί"),
    "profile_camera": MessageLookupByLibrary.simpleMessage("κάμερα"),
    "profile_change_name_id": MessageLookupByLibrary.simpleMessage(
      "εἰκών, ἀλλαγὴ ὀνόματος, ἀριθμός",
    ),
    "profile_gallery": MessageLookupByLibrary.simpleMessage("συλλογή"),
    "profile_hey_there": MessageLookupByLibrary.simpleMessage("χαῖρε"),
    "profile_id_copied": MessageLookupByLibrary.simpleMessage(
      "ἀριθμός εἰς μνήμην ἐγράφη",
    ),
    "profile_name": MessageLookupByLibrary.simpleMessage("ὄνομα"),
    "profile_name_enter": MessageLookupByLibrary.simpleMessage(
      "γράφε τὸ ὄνομά σου",
    ),
    "profile_photo": MessageLookupByLibrary.simpleMessage("φωτογραφία εἰκόνος"),
    "profile_photo_fetch_error": MessageLookupByLibrary.simpleMessage(
      "τι ἐγένετο κακῶς ἐν τῷ κομίζειν φωτογραφίαν εἰκόνος ἐκ τῆς ἀποθήκης",
    ),
    ...
    "theme_dark": MessageLookupByLibrary.simpleMessage("σκοτεινὸς τρόπος"),
    "theme_light": MessageLookupByLibrary.simpleMessage("φωτεινὸς τρόπος"),
    "theme_mode": MessageLookupByLibrary.simpleMessage("τρόπος θέματος"),
    ...
    "verification_resend_code": MessageLookupByLibrary.simpleMessage(
      "ἀποστέλλειν κώδικα πάλιν",
    ),
    "verification_success": MessageLookupByLibrary.simpleMessage(
      "ἐπαληθεύθη καλῶς",
    ),
    "version_capitalized": MessageLookupByLibrary.simpleMessage("ἔκδοσις"),
