...
//			channel.writeAndFlush(payload);
//		}
//		case ADD_OR_SWITCH_TO_NEW_ACCOUNT -> {
...
//	}
//
//	public static void addMemberInfoToPayload1(ByteBuf payload, ErmisDatabase.GeneralPurposeDBConnection conn, int clientID) {
//		List<ClientInfo> member = ActiveClients.getClient(clientID);
//
//		byte[] usernameBytes;
