...
import main.java.io.github.koukobin.ermis.server.util.PropertiesUtil;
...
public final class ConfigurationsPaths {
	...
	static {
		final String configPath = "/main/resources/config.properties";
	...
	public static class Database {
		public static final String DATABASE_SETUP_FILE = "/main/resources/ermis_database/sql/database_setup.sql";
