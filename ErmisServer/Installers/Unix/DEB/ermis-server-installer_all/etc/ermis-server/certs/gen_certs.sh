...
read -s -p "Enter password for CA + cert: " MASTER_PASSWORD
printf '\n'
read -s -p "Enter Password (again): " MASTER_PASSWORD2
printf '\n'
...
KEY_MODULUS=$(openssl rsa -noout -modulus \
    -in "$SERVER_KEY" -passin pass:"$MASTER_PASSWORD" | openssl sha256)
