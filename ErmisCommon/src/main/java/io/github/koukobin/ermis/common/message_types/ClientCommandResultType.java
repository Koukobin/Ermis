 ...
 */
package main.java.io.github.koukobin.ermis.common.message_types;
...
public enum ClientCommandResultType {
	...
	GET_CHAT_SESSIONS_INDICES(302),
	GET_CHAT_SESSIONS_STATUSES(303),
	GET_WRITTEN_TEXT(305),
	DELETE_CHAT_MESSAGE(306),
